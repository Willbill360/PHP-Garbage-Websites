  ...
  <script type="text/javascript">
    $(function() {
      ...
      socket.on('userupd', function (data) {
        $('.counter').html(data.Count).hide().fadeIn();
      });

      socket.on('new message', function(msg){
        $('.commentspace').append('<li style="color:#4286f4;font-size:16px;"><div><b>'+msg.username+'</b></div> <span style="color:#fff;">'+msg.mess+'</span></li>');
      });
