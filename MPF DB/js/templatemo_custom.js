...
//$(".menu-connected").css("display","none");
//$(".menu-connected").slideDown(600);
$(".indexMenu").slideDown(600);
	...
	$(".main_menu a").click(function(){
		...
		$('.slidesick-intero').slick('setPosition');
		$('.slidesick-mission').slick('setPosition');
		$('.slidesick-rapportopen').slick('setPosition');
		$('.slidesick-rapportclose').slick('setPosition');
		$("#menu-container .home").hide();
		return false;
	});
	$("#menu-container .home").show();
...
/*
	$(".main_menu .show-1").click(function(){
		$(".bg-image").fadeOut('slow', function(){
			$(this).css({
				'background-image' : 'url(images/civil_protection_bg.jpg)',
			}).fadeIn('slow');
		});
		return false;
	});
