      ...
      if(isset($_POST['rapport_cancel'])) {
          ...
          if(isset($_POST['rapport_txt'])) {
              if(strlen($_POST['rapport_txt']) <= 255) {
                  ...
                  $date = date("Y-m-d");
                  $insertrap = $bdd->prepare("INSERT INTO rapportsprimaire(createur_matricule, division, statut, date_creation, rapport) VALUES(?, ?, ?, ?, ?)");
                  $insertrap->execute(array($_SESSION['matricule'], "JURY", "opened", $date, $rapport));
                  header('Location: dashboard?id='.$_SESSION['id']);
              }
          }
      }
                    ...
                    <div id="menu-container">
                        ...
                        <div id="menu-1" class="content home indexMenu" style="display: none;">
                            <div class="page-header">
                                <h2 class="page-title">Créé un rapport primaire</h2>
                            </div> <!-- /.page-header -->
                            <div class="content-inner" style="padding-top: 0px;">
                                <div class="row">
                                <form class="contact-form" method="POST">
                                    <label>Rapport</label>
                                    <textarea style="max-width:100%;width:100%;" name="rapport_txt" id="rapport_txt" placeholder="Intervention dans la zone radioactive, nous avons du... blablabla"></textarea>
                                    <input type="submit" name="rapport_cancel" id="rapport_cancel" class="mainBtn" style="width: 49%;" value="Annuler">
