...
//			direction:			"ltr",
			...
			allButtons: {
				...
				link : {
					...
					transform : {
						'<a target="blank_" href="{URL}">{SELTEXT}</a>':"[url={URL}]{SELTEXT}[/url]",
						'<a target="blank_" href="{URL}">{URL}</a>':"[url]{URL}[/url]"
					}
				},
				img : {
					title: CURLANG.img,
				...
				numlist : {
					...
					transform : {
						'<ol>{SELTEXT}</ol>':"[list2]{SELTEXT}[/list2]",
						'<li>{SELTEXT}</li>':"[*]{SELTEXT}[/*]"
					}
				},
				quote : {
				...
				fs_verysmall: {
					...
					exvalue: "1",
					transform: {
						'<font size="1">{SELTEXT}</font>':'[xsmall]{SELTEXT}[/xsmall]'
					}
				},
				fs_small: {
					...
					exvalue: "2",
					transform: {
						'<font size="2">{SELTEXT}</font>':'[small]{SELTEXT}[/small]'
					}
				},
				fs_normal: {
					...
					exvalue: "3",
					transform: {
						'<font size="3">{SELTEXT}</font>':'[normal]{SELTEXT}[/normal]'
					}
				},
				fs_big: {
					...
					exvalue: "4",
					transform: {
						'<font size="4">{SELTEXT}</font>':'[large]{SELTEXT}[/large]'
					}
				},
				fs_verybig: {
					...
					exvalue: "6",
					transform: {
						'<font size="6">{SELTEXT}</font>':'[xlarge]{SELTEXT}[/xlarge]'
					}
				},
