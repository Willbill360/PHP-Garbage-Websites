...
<html>
	<head>
		<title>G.E.P.S - Visualisateur de profil</title>
		<meta charset="utf-8" />
		...
		<script>
			function showLog(str,id) {
			    if (str == "") {
			        ...
			        xmlhttp.open("GET","logs_requester.php?q="+str+":"+id,true);
			        xmlhttp.send();
			    }
			}
		</script>
						...
						<section class="wrapper style5">
							<div align="center" class="inner">
								...
								<table class="table-wrapper">
									<tbody>
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">ID</h5></td>
											<td><h5 style="text-transform:none;"><?php echo $userinfo['id']; ?></h5></td>
										</tr>
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">Nom</h5></td>
											<td><h5 style="text-transform:none;"><?php echo $userinfo['nom']; ?></h5></td>
										</tr>
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">Prénom</h5></td>
											<td><h5 style="text-transform:none;"><?php echo $userinfo['prenom']; ?></h5></td>
										</tr>
										<tr>
										...
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">IP</h5></td>
											<td><h5 style="text-transform:none;"><?php echo $userinfo['ip']; ?></h5></td>
										</tr>
										<tr>
										...
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">Grade</h5></td>                           <!-- 0 = Joueur | 1 = Fonda | 2 = Modo | 3 = Admin | 4 = Admin -->
										...
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">Salon Privé TS</h5></td>
											<td><h5 style="text-transform:none;"><?php echo $userinfo['asTS']; ?></h5></td>
										</tr>
										<?php if($userinfo['asTS'] == "Oui") {?>
											<tr>
												<td style="vertical-align:top;"><h5 style="text-transform:none;">Mois restant</h5></td>
												<td><h5 style="text-transform:none;"><?php echo $userinfo['monthLeft'] + 1; ?></h5></td>
											</tr>
										<?php } ?>
										<tr>
											<td style="vertical-align:top;"><h5 style="text-transform:none;">ID Logs</h5></td>
											<td><h5 style="text-transform:none;"><?php echo $idlogs['rowid']; ?></h5></td>
										</tr>
										<tr>
								...
								<br>
									<div align="center" class="inner">
										<form method="POST" action="">
											<select name="users" onchange="showLog(this.value,<?= $getid ?>)">
										...
										<div id="txtHint"><b>Les logs seront affichez ici...</b></div>
									</div>
									
									
								<div style="margin-top:20px;" class="6u 12u$(medium)">
									<ul class="actions fit">
										<li><a href="profil-browser" class="button fit special">Retour</a></li>
									</ul>
								</div>
							</div>
						</section>
