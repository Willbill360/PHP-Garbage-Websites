...
session_start();
//On inclue les fichier nessesaires
include_once('config.php');
include_once('cookieconnect.php');

//On vérifier qu'il existe un ?id=unchiffre et que le chiffre est plus grand que 0
...
?>
<?php
//On vérifie que l'utilisateur est sur sa page de profil pas celle du voisin
	...
	<body>
		...
		<!-- Page Wrapper -->
            ...
            <!-- On affiche les info du profil -->
                ...
                <!-- jusque ici | apres on affiche des bouton de navigation -->
								...
								<!-- si lutilisateur a le grade 1 on affiche la section admin -->
...
<?php
//Si non on redirectionne vers la page de connexion
	} else {
